  ...
  return (
        <div className={`space-y-5 rounded-2xl border ${navy.border} bg-white p-4`}>
          <div className="flex items-center justify-between gap-2">
            ...
            >
              {selectedPs.isActive === false ? 'فعال کردن' : 'غیرفعال'}
            </button>
          </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid gap-2 sm:grid-cols-3">
                  ...
                  <Input
                    ...
                    placeholder="زمان"
                    value={ruleDuration || ''}
                    onChange={(e) => setRuleDuration(Number(e.target.value) || 60)}
                  />
                </div>
                <button
                  type="button"
                      ...
                      <span className="flex items-center gap-2">
                        <button
                          ...
                          onClick={() => {
                            ...
                            setAddOnName(a.name);
                            setAddOnPrice(a.price || 0);
                            setAddOnExtra(a.extraDurationMin || 0);
